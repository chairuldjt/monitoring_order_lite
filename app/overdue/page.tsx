...
import { ArrowLeft, RefreshCw, AlertTriangle, Timer, ChevronDown, Search, X, ArrowDown, ArrowUp } from 'lucide-react';
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 bg-white/40 backdrop-blur-md p-6 rounded-[2rem] border border-white/20 shadow-xl">
                <div className="flex flex-col gap-2">
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <h1 className="text-2xl font-black text-slate-800">Follow-up Terlambat</h1>
                    </div>
                </div>
                <button
                            ...
                            <thead className="bg-slate-50/80">
                                <tr>
                                    ...
                                    <th
                                        ...
                                        className="px-6 py-4 text-[10px] font-black hover:text-amber-600 text-slate-400 uppercase tracking-widest text-right cursor-pointer transition-colors group select-none"
                                    >
                                        <div className="flex items-center justify-end gap-1.5">
                                            Tanggal
                                            <div className="bg-slate-100 p-1 rounded-md group-hover:bg-amber-100 transition-colors">
                                                {sortOrder === 'desc' ? <ArrowDown className="w-3 h-3 text-slate-400 group-hover:text-amber-600" /> : <ArrowUp className="w-3 h-3 text-slate-400 group-hover:text-amber-600" />}
                                            </div>
                                        </div>
                                    </th>
                                </tr>
                                        ...
                                        >
                                            <td className="px-6 py-4">
                                                <div className="flex flex-col gap-1">
                                                    <span className="text-sm font-bold text-amber-600 group-hover:underline">{order.order_no}</span>
                                                    <div className="flex items-center w-fit bg-red-50 border border-red-100 px-2 py-0.5 rounded-md">
                                                        ...
                                                        <span className="text-[10px] font-black text-red-600">{order.hours_overdue}j</span>
                                                    </div>
                                                </div>
                                            </td>
                                    ...
                                    <tr>
                                        <td colSpan={8} className="px-6 py-20 text-center text-slate-400">
                                            <div className="flex flex-col items-center gap-3">
                                                ...
                                                <p className="font-medium text-slate-400">Tidak ada order yang melewati batas waktu follow up.</p>
                                            </div>
                                        </td>
                                    </tr>
                                )}
