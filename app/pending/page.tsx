...
import { ArrowLeft, RefreshCw, Clock, ChevronDown, Search, X, ArrowDown, ArrowUp, Phone, ArrowRight } from 'lucide-react';
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 bg-white/40 backdrop-blur-md p-6 rounded-[2rem] border border-white/20 shadow-xl">
                <div className="flex flex-col gap-2">
                    ...
                    <div className="flex items-center gap-3">
                        <div className="w-10 h-10 bg-gradient-to-br from-red-500 to-rose-700 rounded-xl flex items-center justify-center shadow-lg border border-white/20">
                            <Clock className="w-5 h-5 text-white" />
                        </div>
                        <div>
                            <h1 className="text-2xl font-black text-slate-800">Over Pending</h1>
                            <div className="flex items-center gap-2 mt-0.5">
                                <span className="w-2 h-2 bg-rose-500 rounded-full animate-pulse"></span>
                                <p className="text-[10px] text-slate-400 uppercase tracking-widest font-bold">{orders.length} order tertahan lama</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div className="bg-white/60 backdrop-blur-md rounded-[2.5rem] border border-white/20 shadow-xl overflow-hidden min-h-[400px]">
                {loading ? (
                    ...
                    <div className="p-20 flex flex-col items-center justify-center text-center">
                        ...
                        <h3 className="text-lg font-black text-slate-800 uppercase tracking-widest">Bersih!</h3>
                        <p className="text-sm text-slate-500 font-medium">Tidak ada order yang berstatus pending lebih dari 1 bulan.</p>
                    </div>
                ) : (
                                    ...
                                    <tr key={i} className="hover:bg-red-50/30 transition-colors group">
                                        <td className="px-6 py-5 align-top">
                                            <div className="flex flex-col">
                                                <span className="text-xs font-black text-red-600 uppercase tracking-wider">{order.order_no}</span>
                                                <div className="flex items-center gap-1 mt-1 bg-rose-50 border border-rose-100 px-2 py-0.5 rounded-md w-fit">
                                                    ...
                                                    <span className="text-[9px] font-black text-rose-600 uppercase tracking-tighter">{order.days_overdue} Hari Tertunda</span>
                                                </div>
                                            </div>
                                        </td>
                                        <td className="px-6 py-5 align-top">
